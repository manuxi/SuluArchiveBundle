...
{
    public const NAV_ITEM = 'sulu_archive.archives';

    public const LIST_VIEW = 'sulu_archive.archive.list';
    public const ADD_TABS_VIEW = 'sulu_archive.archive.add_tabs';
    public const EDIT_TABS_VIEW = 'sulu_archive.archive.edit_tabs';
    ...
    public function configureNavigationItems(NavigationItemCollection $navigationItemCollection): void
    {
        if ($this->securityChecker->hasPermission(Archive::SECURITY_CONTEXT, PermissionTypes::EDIT)) {
            ...
            $rootNavigationItem->setPosition(38);
    ...
    public function configureViews(ViewCollection $viewCollection): void
    {
        ...
        } elseif ($this->securityChecker->hasPermission(Archive::SECURITY_CONTEXT, PermissionTypes::EDIT)) {
        ...
        if ($this->securityChecker->hasPermission(Archive::SECURITY_CONTEXT, PermissionTypes::EDIT)) {
            ...
            $viewCollection->add(
                $this->viewBuilderFactory->createListViewBuilder(static::LIST_VIEW, '/' . $resourceKey . '/:locale')
                    ...
                    ->setTitle('sulu_archive.' . $resourceKey)
